...
import com.sample.common.util.ContextUtil;
import com.sample.common.util.I18nUtils;
...
public class CustomErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(WebRequest webRequest, ErrorAttributeOptions options) {
        ...
        String name = ErrorAttributes.class.getName() + ".error";// ErrorAttributes.ERROR_ATTRIBUTE;
        Object exception = webRequest.getAttribute(name, RequestAttributes.SCOPE_REQUEST);
